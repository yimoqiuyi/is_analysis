    ...
    <div class="layui-body">
        <div style="padding: 15px;">
            ...
            <script type="text/html" id="barDemo">
                ...
                <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="detai2">角色用户</a>
            </script>
...
<script>
    ...
    layui.use(['laypage', 'layer', 'table', 'element', 'slider'], function () {
        ...
        table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'detail') {
                window.location.href = "${pageContext.request.contextPath}/admin/userRoleDistribution.do?userId=" + data.userId
                layer.msg('查看操作');
            } else if (layEvent === 'detai2') {
                layer.confirm('查看', function (index) {
                    window.location.href = "${pageContext.request.contextPath}/admin/checkUserRole.do?userId=" + data.userId
