...
%>
<form class="layui-form" action="${pageContext.request.contextPath}/admin/updateToPermission.do">
             <input type="hidden" name="id" value="<%=permission.getId()%>"  >
     <div class="layui-form-item">
        <label class="layui-form-label">权限名:</label>
        <div class="layui-input-block">
            <input type="text" name="name" value="<%=permission.getName()%>" required lay-verify="required"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="node"  placeholder="请输入内容" class="layui-textarea"><%=permission.getNode()%></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
