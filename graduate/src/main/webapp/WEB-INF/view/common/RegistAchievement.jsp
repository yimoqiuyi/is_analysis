            ...
            <form class="layui-form" action="${pageContext.request.contextPath}/subpark/insertToAchievement.do">
                 <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="achievementsName" required  lay-verify="required" placeholder="请输入名字" autocomplete="off" class="layui-input">
                    </div>
                </div>
                 <div class="layui-form-item">
                    <label class="layui-form-label">成果类别:</label>
                    <div class="layui-input-block">
                        <input type="text" name="achievementsCategory"  required  lay-verify="required" placeholder="请设置类别" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">分数:</label>
                    <div class="layui-input-block">
                        <input type="text" name="achievementsScore"  required  lay-verify="required" placeholder="请设置分数" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">成果简介:</label>
                    <div class="layui-input-block">
                        <textarea name="achievementsIntroduction"  placeholder="请输入简介"  class="layui-textarea"></textarea></div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
