    ...
    <div class="layui-body">
        <div style="padding: 15px;">
            <form id="sch-form" class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/general/subparkResponsibilityagreementByTime.do" lay-filter="sch-form">
    ...
    <script>
        ...
        layui.use(['laypage', 'layer','laydate', 'table', 'element', 'slider'], function () {
            ...
            table.render({
                elem: '#demo'
                , height: 420
                , url: 'subparkResponsibilityagreementByTime.do?subParkId=' + subParkId+'&beginTime='+beginTime+'endTime'+lastTime  //数据接口
                , title: '用户表'
                , page: true //开启分页
