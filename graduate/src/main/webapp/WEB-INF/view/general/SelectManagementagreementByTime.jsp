...
<input type="hidden" value="${endTime}" id="lastTime">
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <div style="padding: 15px;">
            <form id="sch-form" class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/general/selectManagementagreementByTime.do"
                  lay-filter="sch-form">
    ...
    <script>
        ...
        layui.use(['laypage', 'laydate', 'layer', 'table', 'element', 'slider'], function () {
            ...
            table.render({
                ...
                height: 420
                ,
                url: 'subparkManagementagreementByTime.do?subParkId=' + subParkId + '&beginTime=' + beginTime + 'endTime' + lastTime //数据接口
                ,
                title: '用户表'
                ,
                page: true //开启分页
