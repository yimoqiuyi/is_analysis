    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body">
            <div style="padding: 15px;">
                <form id="sch-form" class="layui-form layui-form-pane" action="${pageContext.request.contextPath}/general/fuzzyGroupSanitation.do" lay-filter="sch-form" >
                    <input type="hidden" value="${subParkId}" name="subParkId">
                     <div class="layui-inline">
                        <div class="layui-input-block">
                            <input name="condition" type="text" autocomplete="off"   placeholder="姓名" class="layui-input laydate">
                        </div>
                    </div>
            ...
            <div style="padding: 15px;">
                ...
                <script type="text/html" id="barDemo">
                    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">团队卫生</a>
                </script>
    ...
    <script>
        ...
        layui.use(['laypage', 'layer', 'table', 'element', 'slider'], function () {
            ...
            table.render({
                elem: '#demo'
                , height: 420
                , url: 'fuzzyGroupSanitation1.do?subParkId='+subParkId+'&condition='+condition//数据接口
                , title: '用户表'
                , page: true //开启分页
            ...
            table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'detail'){
                    window.location.href = "${pageContext.request.contextPath}/general/groupSanitation.do?groupId=" + data.groupId
                    layer.msg('查看操作');
                }
            });
            //分页
