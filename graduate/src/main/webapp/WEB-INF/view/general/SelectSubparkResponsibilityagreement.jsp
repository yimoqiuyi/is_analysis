        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class=""
                       href="${pageContext.request.contextPath}/general/selectSubparkAgreement.do?subParkId=${subParkId}">
                        入园合同</a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a class=""
                       href="${pageContext.request.contextPath}/general/selectSubparkManagementagreement.do?subParkId=${subParkId}">
                        资产协议表</a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a class=""
                       href="${pageContext.request.contextPath}/general/selectSubparkResponsibilityagreement.do?subParkId=${subParkId}">
                        卫生协议表</a>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-body">
        <div style="padding: 15px;">
            <form id="sch-form" class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/general/selectResponsibilityagreementByTime.do"
                  lay-filter="sch-form">
    ...
    <script>
        ...
        layui.use(['laypage', 'layer', 'laydate', 'table', 'element', 'slider'], function () {
            ...
            table.render({
                elem: '#demo'
                , height: 420
                , url: 'subparkResponsibilityagreement.do?subParkId=' + subParkId //数据接口
                , title: '用户表'
                , page: true //开启分页
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'responsibleId', title: 'ID', width: 40, sort: true, fixed: 'left', totalRowText: '合计：'}
                    , {field: 'responsibleName', title: '合同名称', width: 120}
                    , {field: 'responsibleIntroduce', title: '合同介绍', width: 120}
            ...
            table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'detail') {
                    window.location.href = "${pageContext.request.contextPath}/general/downLoadResponsibilityagreement.do?responsibleId=" + data.responsibleId
                    layer.msg('查看操作');
                }
            });
            //分页
