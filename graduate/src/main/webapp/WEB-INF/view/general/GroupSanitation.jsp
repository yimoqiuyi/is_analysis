...
<script>
    ...
    layui.use(['laypage', 'layer', 'table', 'element', 'slider'], function () {
        ...
        table.render({
            elem: '#demo'
            , height: 420
            , url: 'checkUserSanitation.do?groupId=' + groupId //数据接口
            , title: '用户表'
            , page: true //开启分页
            ...
            , cols: [[ //表头
                ...
                , {field: 'sanitationScore', title: '卫生分数', width: 100}
        ...
        table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'detail') {
                window.location.href = "${pageContext.request.contextPath}/general/selectUserSanitation.do?userId=" + data.userId
                layer.msg('查看操作');
            }
         });
        //分页
