    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body">
            <div style="padding: 15px;">
                <form id="sch-form" class="layui-form layui-form-pane" action="${pageContext.request.contextPath}/subpark/selectManagementagreementBytime.do" lay-filter="sch-form" >
                    ...
                    <c:forEach  items="${managementagreementList}" var="item">
                        <tr>
                            ...
                            <td><a href="${pageContext.request.contextPath}/group/ManagementagreementDownload.do?managementId=${item.managementId}"
                                   class="layui-btn layui-btn-sm layui-btn-sm">下载</a>></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
