...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <script type="text/html" id="barDemo">
            <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">团队合同</a>
         </script>
    ...
    <script>
        ...
        layui.use(['laypage', 'layer', 'table', 'element', 'slider'], function () {
            ...
            table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'detail') {
                    window.location.href = "${pageContext.request.contextPath}/subpark/subparkGroupAgreement.do?groupId=" + data.groupId
                    layer.msg('查看操作');
                }
            });
            //分页
