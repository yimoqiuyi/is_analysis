    ...
    <c:if test="${not empty sessionScope.user}">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-left">
                ...
                <li class="layui-nav-item"><a
                        href="${pageContext.request.contextPath}/subpark/selectPerformance.do">绩效管理</a></li>
                <li class="layui-nav-item"><a
            ...
            <form class="layui-form" action="${pageContext.request.contextPath}/subpark/updateOnePerformance.do"
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <input type="text" name="performanceId" value="<%=performance.getPerformanceId()%>"
                               hidden>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="startTime" id="assessmentStartTime"
                               value="<%=performance.getStartTime()%>" required lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="endTime" id="assessmentEndTime" value="<%=performance.getEndTime()%>"
