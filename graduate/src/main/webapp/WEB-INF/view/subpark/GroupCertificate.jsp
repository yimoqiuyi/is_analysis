    ...
    <div class="layui-layout layui-layout-admin">
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    <li class="layui-nav-item layui-nav-itemed">
                        <a class="" href="${pageContext.request.contextPath}/subpark/achievementsOperation.do">
                            成果配置</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="layui-body">
            ...
            <script type="text/html" id="barDemo">
                <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">专利</a>
                <a class="layui-btn layui-btn-xs" lay-event="detai2">论文</a>
                <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detai3">软著</a>
                <a class="layui-btn layui-btn-xs" lay-event="detai4">竞赛</a>
            </script>
    ...
    <script>
        ...
        layui.use(['laypage', 'layer', 'table', 'element', 'slider'], function () {
            ...
            table.render({
                elem: '#demo'
                , height: 420
                , url: 'selectGroupCertificate.do' //数据接口
                , title: '用户表'
                , page: true //开启分页
            ...
            table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'detail'){
                    window.location.href = "${pageContext.request.contextPath}/subpark/selectGroupPatent.do?groupId=" + data.groupId
                    layer.msg('查看操作');
                } else if (layEvent === 'detai2') {
                    window.location.href = "${pageContext.request.contextPath}/subpark/selectGroupPaper.do?groupId=" + data.groupId
                    layer.msg('查看操作');
                } else if (layEvent === 'detai3') {
                    window.location.href = "${pageContext.request.contextPath}/subpark/selectGroupSoftware.do?groupId=" + data.groupId
                    layer.msg('查看操作');
                }else if (layEvent === 'detai4') {
                    window.location.href = "${pageContext.request.contextPath}/subpark/selectGroupCompetition.do?groupId=" + data.groupId
                    layer.msg('查看操作');
                }
            });
            //分页
