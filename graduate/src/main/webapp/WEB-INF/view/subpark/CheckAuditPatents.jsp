        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class=""
                       href="${pageContext.request.contextPath}/subpark/selectGroupPatent.do?groupId=<%=groupId%>">
                        专利审核</a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a class=""
                       href="${pageContext.request.contextPath}/subpark/checkAuditPatents.do?groupId=<%=groupId%>">
                        查看专利</a>
                </li>
            </ul>
        </div>
             ...
             <table class="layui-table" lay-even lay-skin="nob">
                ...
                <c:forEach items="${patentList}" var="item">
                    <tr>
                        ...
                        <td><%="已审核"%></td>
                        <td>
                            <a href="${pageContext.request.contextPath}/subpark/downLoadPatent.do?patentId=${item.patentId}"
