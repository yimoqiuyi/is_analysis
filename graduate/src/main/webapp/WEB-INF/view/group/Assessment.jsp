<%@ page contentType="text/html;charset=UTF-8" language="java"
         pageEncoding="utf-8" import="com.yp.common.pojo.AssessmentReport" %>
        ...
        <div class="layui-side layui-bg-black">
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        <a class="" href="${pageContext.request.contextPath}/group/selectAchievements.do">查看详情</a>
                    </li>
                 </ul>
            </div>
        </div>
        <div class="layui-body">
            ...
            <div style="padding: 15px;">
                <table class="layui-table" lay-even lay-skin="nob">
                    ...
                    <tbody>
                    <tr>
                        <td><%=assessmentReport.getReportId()%></td>
                        <td><%=assessmentReport.getAssessmentMessage()%></td>
                        <td><%=assessmentReport.getsDescription()%></td>
                        <td><%=assessmentReport.getAttendanceDescription()%></td>
                        <td><%=assessmentReport.getGroupId()%></td>
                    </tr>
                     </tbody>
                </table>
            </div>
