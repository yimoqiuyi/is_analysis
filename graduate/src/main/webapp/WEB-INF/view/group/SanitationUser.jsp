        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="${pageContext.request.contextPath}/group/selectSanitation.do?userId=<%=user.getUserId()%>">
                        卫生查看</a>
                </li>
                <li class="layui-nav-item">
            ...
            <table class="layui-table" lay-even lay-skin="nob">
                ...
                <tr>
                    ...
                    <td><%=user.getUserName()%></td>
                     <td><%=user.getSanitationScore()%></td>
                    <td><%=user.getWorkSanitation()%></td>
                </tr>
                </tbody>
            </table>
        </div>
        <div style="padding: 15px;">
            <table class="layui-table" title="卫生扣分项" lay-even lay-skin="nob">
                <colgroup>
                    <col width="100">
                    <col width="100">
                    <col width="100">
