...
public interface ResponsibilityagreementService {
    //同意主键获取卫生协议表
    public Responsibilityagreement selectOneResponsibilityagreementById(@Param("responsibleId") int responsibleId);

    //通过团队外键获取卫生协议
    public List<Responsibilityagreement> selectAllResponsibilityagreementBygroupId(@Param("groupId") int groupId);
