    ...
    <script>
        ...
        layui.use(['laypage', 'layer', 'table', 'element', 'slider'], function () {
            ...
            table.render({
                elem: '#demo'
                , height: 420
                , url: 'selectBuildingRoom.do?subParkId=' + subParkId //数据接口
                , title: '用户表'
                , page: true //开启分页
                ...
                <%--switch (obj.event) {--%>
                    ...
                    <%--case 'update':--%>
                        ...
                        <%--} else {--%>
                            ...
                            <%--window.location.href = "${pageContext.request.contextPath}/subpark/selectOneRoom.do?roomId=" + id--%>
            ...
            table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'detail') {
                    window.location.href = "${pageContext.request.contextPath}/general/selectRoomParkassets.do?roomId=" + data.roomId
                    layer.msg('查看操作');
                }
            });
            //分页
