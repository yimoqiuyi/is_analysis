...
<script>
    ...
    layui.use(['laypage', 'layer', 'table', 'element', 'slider'], function () {
        ...
        table.render({
            elem: '#demo'
            , height: 420
            , url: 'generalSoftware.do?subParkId=' + subParkId //数据接口
            , title: '软著表'
            , page: true //开启分页
            ...
            , cols: [[ //表头
                ...
                , {field: 'softId', title: 'ID', width: 40, sort: true, fixed: 'left', totalRowText: '合计：'}
                , {field: 'softName', title: '名称', width: 100}
                , {field: 'softPeopleMame', title: '著作权人', width:160}
                , {field: 'softGrade', title: '软著级别', width: 140}
                , {field: 'dateofAuthorization', title: '授权日期', width: 140}
                , {field: 'certificateNumber', title: '证书号', width: 100}
                , {field: 'registrationNumber', title: '登记号', width: 100}
                , {field: 'softwareAuditTime', title: '审核时间', width: 160}
                , {field: 'softwareState', title: '状态', width: 100}
        ...
        table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'detail') {
                window.location.href = "${pageContext.request.contextPath}/general/selectGroupSoftware.do?groupId=" + data.groupId
                layer.msg('查看操作');
            }
