    ...
    <div class="layui-body">
        <div style="padding: 15px;">
            <form id="sch-form" class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/general/selectAdmissioncontractByTime.do" lay-filter="sch-form">
    ...
    <script>
        ...
        layui.use(['laypage', 'layer', 'table', 'element', 'slider','laydate'], function () {
            ...
            table.render({
                elem: '#demo'
                , height: 420
                , url: 'subparkAdmissioncontractByTime.do?subParkId=' + subParkId+ '&beginTime='+beginTime+'endTime'+lastTime//数据接口
                , title: '用户表'
                , page: true //开启分页
