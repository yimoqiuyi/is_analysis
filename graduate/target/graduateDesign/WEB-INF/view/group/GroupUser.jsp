            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                    <li class="layui-nav-item layui-nav-itemed">
                        <a class="" href="${pageContext.request.contextPath}/user/check.do">团队成员</a>
                    </li>
                    <li class="layui-nav-item">
                        <a href="javascript:;">成员操作</a>
                        <dl class="layui-nav-child">
                            <dd><a href="${pageContext.request.contextPath}/user/insert.do">成员录入</a></dd>
                            <dd><a href="javascript:;">成员删除</a></dd>
                        </dl>
                    </li>
                </ul>
            </div>
