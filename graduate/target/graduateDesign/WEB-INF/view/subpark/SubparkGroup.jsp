        ...
        <div class="layui-side layui-bg-black">
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    <li class="layui-nav-item layui-nav-itemed">
                        <a class="" href="${pageContext.request.contextPath}/subpark/performanceOperation.do">
                            团队绩效</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="layui-body">
             ...
             <script type="text/html" id="barDemo">
                ...
                <a class="layui-btn layui-btn-xs" lay-event="detai2">任务</a>
    ...
    <script>
        ...
        layui.use(['laypage', 'layer', 'table', 'element', 'slider'], function () {
                ...
                switch (obj.event) {
                    case 'add':
                        var id = checkStatus.data[0].subParkId;
                          window.location.href = "${pageContext.request.contextPath}/subpark/registGroup.do?subParkId="+id
                        layer.msg('添加');
                        break;
                    case 'update':
                        if (data.length === 0) {
            ...
            table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'detail') {
                    window.location.href = "${pageContext.request.contextPath}/subpark/selectGroup.do?groupId=" + data.groupId
                    layer.msg('查看操作');
                } else if (layEvent === 'detai2') {
                    window.location.href = "${pageContext.request.contextPath}/subpark/getAllAchievements.do?groupId=" + data.groupId
                    layer.msg('查看操作');
                } else if (layEvent === 'del') {
                    layer.confirm('真的删除行么', function (index) {
                        window.location.href = "${pageContext.request.contextPath}/subpark/deleteGroup.do?groupId=" + data.groupId
                        obj.del(); //删除对应行（tr）的DOM结构
                        layer.close(index);
                        //向服务端发送删除指令
                    });
                } else if (layEvent === 'edit') {
                    window.location.href = "${pageContext.request.contextPath}/subpark/updateGroup.do?groupId=" + data.groupId
                    layer.msg('编辑操作');
                }
            });
            //分页
