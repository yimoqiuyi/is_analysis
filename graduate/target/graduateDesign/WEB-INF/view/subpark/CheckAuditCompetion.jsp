        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class=""
                       href="${pageContext.request.contextPath}/subpark/selectGroupCompetition.do?groupId=<%=groupId%>">
                        论文审核</a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a class=""
                       href="${pageContext.request.contextPath}/subpark/checkAuditCompetion.do?groupId=<%=groupId%>">
                        查看论文</a>
                </li>
            </ul>
        </div>
        ...
        <table class="layui-table" lay-even lay-skin="nob">
            ...
            <c:forEach items="${competitionList}" var="item">
                <tr>
                    ...
                    <td>${item.competitionLevel}</td>
                    <td>${item.sponsor}</td>
                    <td>${item.nameofMember}</td>
                    <td>${item.awardLevel}</td>
                    <td>${item.competitionAuditTime}</td>
                    <td><%="已审核"%>
                    </td>
                    <td>
                        <a href="${pageContext.request.contextPath}/subpark/selectCompetion.do?competitionId=${item.competitionId}"
                           class="layui-btn layui-btn-sm layui-btn-normal">下载</a>
                        <a href="${pageContext.request.contextPath}/subpark/deleteCompetion.do?competitionId=${item.competitionId}"
