...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <form class="layui-form" action="${pageContext.request.contextPath}/subpark/updateParkassets.do" method="post">
                <div class="layui-form-item">
                     <div class="layui-input-block">
                        <input type="text" name="assetId" value="<%=parkassets.getAssetId()%>"  hidden>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">桌子数量:</label>
                    <div class="layui-input-block">
                        <input type="text" name="tableNum" value="<%=parkassets.getTableNum()%>" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">椅子数量:</label>
                    <div class="layui-input-block">
                        <input type="text" name="chairNum"  value="<%=parkassets.getChairNum()%>" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">空调数量</label>
                    <div class="layui-input-block">
                        <input type="text" name="airconditioningNum" value="<%=parkassets.getAirconditioningNum()%>" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">窗帘数量</label>
                    <div class="layui-input-block">
                        <input type="text" name="curtainNum" value="<%=parkassets.getCurtainNum()%>" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">饮水机数量</label>
                    <div class="layui-input-block">
                        <input type="text" name="WaterdispenserNum" value="<%=parkassets.getWaterdispenserNum()%>" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">电插板数量</label>
                    <div class="layui-input-block">
                        <input type="text" name="electricboardNum"  value="<%=parkassets.getElectricboardNum()%>" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
