    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="${pageContext.request.contextPath}/subpark/attendanceOperation.do">
                        考勤设置</a>
                </li>
            </ul>
        </div>
        ...
        <div class="layui-body">
            ...
            <script type="text/html" id="barDemo">
                ...
                <a class="layui-btn layui-btn-xs" lay-event="detai2">团队考勤</a>
             </script>
    ...
    <script>
        ...
        layui.use(['laypage', 'layer', 'table', 'element', 'slider'], function () {
            ...
            table.render({
                elem: '#demo'
                , height: 420
                , url: 'selectGroupAttendance.do' //数据接口
                , title: '用户表'
                , page: true //开启分页
            ...
            table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'detail'){
                    window.location.href = "${pageContext.request.contextPath}/subpark/checkAssessmentReport.do?groupId=" + data.groupId
                    layer.msg('查看操作');
