...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class=""
                       href="${pageContext.request.contextPath}/subpark/checkAssessmentReport.do?groupId=<%=assessmentReport.getGroupId()%>">
                        考核信息</a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a class=""
                       href="${pageContext.request.contextPath}/subpark/selectSanitation.do?groupId=<%=assessmentReport.getGroupId()%>">
                        卫生信息</a>
                </li>
                <li class="layui-nav-item">
                    <a href="${pageContext.request.contextPath}/subpark/selectAttendance.do?groupId=<%=assessmentReport.getGroupId()%>">
                        考勤信息</a>
                </li>
                <li class="layui-nav-item">
                    <a href="${pageContext.request.contextPath}/subpark/selectAchievementsNumber.do?groupId=<%=assessmentReport.getGroupId()%>">
                        成果信息</a>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <form class="layui-form" action="${pageContext.request.contextPath}/subpark/updateAssessmentReport.do">
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <input type="text" name="reportId" value="<%=assessmentReport.getReportId()%>" hidden>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                           <textarea name="assessmentMessage" placeholder="任务情况"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea name="sDescription" placeholder="卫生情况"
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                            <textarea name="attendanceDescription" placeholder="考勤情况"
                                      class="layui-textarea"> <%=assessmentReport.getAttendanceDescription()%></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <input type="text" name="groupId" value="<%=assessmentReport.getGroupId()%>" hidden>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button class="layui-btn" type="submit" lay-submit lay-filter="formDemo">修改</button>
                        <button class="layui-btn" type="reset" lay-submit lay-filter="formDemo">撤销</button>
                    </div>
                </div>
            </form>
        </div>
