        ...
        <div class="layui-body">
            <div style="padding: 15px;">
                <form id="sch-form" class="layui-form layui-form-pane"
                      action="${pageContext.request.contextPath}/subpark/selectResponsibilityagreementBytime.do" lay-filter="sch-form">
            ...
            <div style="padding: 15px;">
                <table class="layui-table" lay-even lay-skin="nob">
                    ...
                    <tbody>
                    <c:forEach items="${responsibilityagreementList}" var="item">
                        <tr>
                            <td>${item.responsibleId}</td>
                            <td>${item.responsibleName}</td>
                            <td>${item.responsibleIntroduce}</td>
                            <td>${item.signDate}</td>
