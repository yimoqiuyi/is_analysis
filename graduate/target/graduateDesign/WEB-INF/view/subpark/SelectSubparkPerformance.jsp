    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body">
            <div style="padding: 15px;">
                <form id="sch-form" class="layui-form layui-form-pane" action="${pageContext.request.contextPath}/subpark/selectSubparkPerformance.do" lay-filter="sch-form" >
                ...
                <table class="layui-table" lay-even lay-skin="nob">
                    ...
                    <c:forEach  items="${performanceList}" var="item">
                        <tr>
                            ...
                            <td><a href="${pageContext.request.contextPath}/subpark/checkGroupPerformance.do?groupId=${item.groupId}"
                                   class="layui-btn layui-btn-warm">查看</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
